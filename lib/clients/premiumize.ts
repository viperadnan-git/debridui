...
export default class PremiumizeClient extends BaseClient {
    ...
    // Web download methods - not yet supported by Premiumize
    async addWebDownloads(_links: string[]): Promise<WebDownloadAddResult[]> {
        throw new DebridError("Web downloads not supported by Premiumize", "NOT_SUPPORTED");
    }
    ...
    async deleteWebDownload(_id: string): Promise<void> {
        throw new DebridError("Web downloads not supported by Premiumize", "NOT_SUPPORTED");
    }
}
