...
export function FileActionsDrawer({ files }: FileActionsDrawerProps) {
    ...
    return (
        <>
            ...
            <div
                className={cn(
                    "fixed bottom-[calc(56px+env(safe-area-inset-bottom))] md:bottom-0 left-0 right-0 z-40 bg-background/95 backdrop-blur-sm border-t border-border/50 shadow-lg transition-transform duration-300 ease-in-out",
